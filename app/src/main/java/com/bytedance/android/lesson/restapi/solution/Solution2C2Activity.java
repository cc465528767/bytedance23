...
public class Solution2C2Activity extends AppCompatActivity {
    ...
    private void postVideo() {
        ...
        Call<PostVideoResponse> postVideoResponseCall =iMiniDouyinService.createVideo("3220180908","郑笑寒",
        ...
        postVideoResponseCall.enqueue(new Callback<PostVideoResponse>() {
            ...
            public void onResponse(Call<PostVideoResponse> call, Response<PostVideoResponse> response) {
                ...
                Log.d("LoL","访问成功"+response.body().toString()+call.toString());
    ...
    public void fetchFeed(View view) {
        ...
        Call<FeedResponse> call = iMiniDouyinService.getFeed();
        call.enqueue(new Callback<FeedResponse>() {
            @Override
            public void onResponse(Call<FeedResponse> call, Response<FeedResponse> response) {
                Log.i("LHD","访问成功"+response.body().toString()+call.toString());

               FeedResponse feedResponse=response.body();
               loadPics(feedResponse.getFeeds());
                for (Feed cat:mFeeds){
                    Log.d("LHD", cat.getImage_url().toString());}
    ...
    private void loadPics(List<Feed> feed) {
        mFeeds = feed;
